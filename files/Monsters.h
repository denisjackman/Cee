	...
	/*	See types.h under creature_type for a complete list	of all variables for creatures.
	    Some of the less obvious are explained below.

Hit points:	#1, #2: where #2 is the range of each roll and #1 is the number of added up rolls to make.
			Example: a creature with 5 eight-sided hit die is given {5,8}.
...
Example:  For a creature which bites for 1d6, then stings for 2d4 and loss of dex you would use: {1,2,1,6},{15,4,2,4}
...
Sleep (sleep)	        :	A measure in turns of how fast creature will notice player (on the average).
Area of affect (aaf)    :	Max range that creature is able to "notice" the player.
									*/
...
{
  char *name;		/* Description of creature  */
  ...
  int8u ac;		    /* Armour CLass (AC)        */
  int8u speed;		/* Movement speed+10	    */
  int8u cchar;		/* Character Representaion. */
...
/*{"Creature Description"     ,"cmove"    ,"Spells"   ,"cdefense",Exp,Sleep,aaf, AC, Speed, Rep, Hit, attack,           level }*/
