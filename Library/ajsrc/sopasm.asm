...
PUBLIC _farmemmove,_writechar,_poscurs,_clearline,_inittimer,_farmemset
PUBLIC _restoreints,_setgmode,_getwordfromport,_cgafbar,_initkeyboard,_getkey
PUBLIC _kbhit
...
_restoreints:
  ...
  ES: MOV W[022],AX
  CS: MOV AX,W[keyhandlerinstalled]
  OR AX,AX
  JZ nokeybinstalled
